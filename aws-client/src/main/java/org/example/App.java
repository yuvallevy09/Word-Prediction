...
public class App {
    ...
    public static void main(String[]args){
        ...
        HadoopJarStepConfig step1 = new HadoopJarStepConfig()
                .withJar("s3n://yuvalhagarwordprediction/step1.jar") // This should be a full map reduce application.
                .withMainClass("Step1");
        ...
        RunJobFlowRequest runFlowRequest = new RunJobFlowRequest()
                ...
                .withSteps(stepConfig1, stepConfig2) //change according to the number of steps
